...
export default function HomePage() {
  return (
    <div className="flex min-h-dvh flex-col bg-paper">
      ...
      <main className="mx-auto flex w-full max-w-[1200px] flex-1 flex-col px-5 pb-8 pt-10 sm:px-8 sm:pb-12 sm:pt-16">
        <section className="grid flex-1 items-stretch gap-8 lg:grid-cols-12 lg:gap-6">
          <div className="flex flex-col justify-between lg:col-span-7 lg:py-5">
            <div>
              <h1 className="text-balance max-w-[760px] text-[clamp(3rem,5vw,4rem)] font-semibold leading-[1.02] tracking-[-0.035em] text-obsidian">
                Cleaner streets begin with one clear signal.
              </h1>
              <p className="mt-7 max-w-[62ch] text-base leading-relaxed text-steel sm:text-lg">
                A citizen view of illegal dumping across Selangor. Explore the
                map, follow solved reports and capture a live, geotagged case in
                minutes.
              </p>
            </div>
          ...
          <article className="overflow-hidden rounded-[36px] border border-cloud bg-snow lg:col-span-5">
        ...
        <section className="mt-8 grid overflow-hidden rounded-[36px] border border-cloud bg-snow lg:mt-12 lg:grid-cols-[1.35fr_0.65fr]">
